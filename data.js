...
data = {
  ...
  children: [
    { name: "Magic Machine",
      children: [
        {name: "TV Show", value: 555},
        {name: "Comic",   value: 611},
        {name: "Goblin Town", value: 800},
        {name: "Shadow Hats", value: 300},
      ]
    },
    {name: "House of Wizards DAO", value: 1100},
    {name: "Wizard Wednesday", value: 600},
    { name: "Collections",
      children: [
        {name: "Forgotten Runes Wizards & Souls Cult", value: 2000},
        {name: "Forgotten Runes Warriors Guild", value: 1400},
        {name: "Forgotten Runes Beasts", value: 1400},
        {name: "Forgotten Runes Ponies", value: 500},
        {name: "Forgotten Runes Spawn", value: 500},
        {name: "Forgotten Runes Sacred Flames", value: 300},
        {name: "Forgotten Runes Items", 
          children: [
            {name: "Locks", value: 400},
            {name: "Athaeneum", value: 300},
            {name: "Tricks", value: 100},
            {name: "Imp Boxes", value: 200},
          ]
        },
        {name: "Shadow Hats on Bitcoin", value: 100},
      ],
    },
    { name: "Lore",
      children: [
        {name: "Book of Lore", value: 1500},
        {name: "Wizzypedia", value: 800},
        {name: "Loracle", value: 400 },
      ],
    },
    { name: "Community Projects",
      children: [
        { name: "BlackSands",
          children: [
            {name: "BlackSands Pony Racing", value: 400},
            {name: "BlackSands Duels", value: 200},
          ],
        },
        { name: "Runes TCG", value: 300},
        { name: "Forgotten Worlds", value: 300},
        { name: "Wizard Nouns", value: 100},
        { name: "Forgotten Babies", value: 100},
        { name: "Forgotten Punks", value: 100},
        { name: "Black Hat Ballads", value: 100},
        { name: "The Barren Court", value: 100},
        { name: "Cabinet of Curiosities", value: 100},
        { name: "Heroes of Cumberland", value: 50},
        { name: "Two Crows Bazaar", value: 50},
      ]
    },
    { name: "Guilds",
      children: [
        { name: "Milk Guild", value: 50 },
        { name: "Big Potion", value: 50 },
        { name: "Hall of Cats", value: 50 },
      ],
    },
    { name: "Digital Places",
      children: [
        { name: "Discord", value: 300 },
        { name: "Twitter", value: 200 },
        { name: "Buy & Sell",
          children: [
            {name: "Forgotten Market", value: 300},
            {name: "OpenSea", value: 300},
            {name: "Blur.io", value: 100},
            {name: "x2y2", value: 100},
            {name: "NFTx Vault for Wizards", value: 100},
            {name: "NFTx Vault for Warriors", value: 100},
          ],
        },
        { name: "Emoji Servers",
           children: [
           { name: "Kobolds", value: 44, uri: "https://discord.gg/QU92em8J9B" },
           { name: "Magus Wazir", value: 44, uri: "https://discord.gg/QU92em8J9B" },
           { name: "Kobolds", value: 44, uri: "https://discord.gg/QU92em8J9B" },
           { name: "Kobolds", value: 44, uri: "https://discord.gg/QU92em8J9B" },
           { name: "Kobolds", value: 44, uri: "https://discord.gg/QU92em8J9B" },
          ]
